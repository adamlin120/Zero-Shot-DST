...
def loadData(args):
    ...
    if args.mwz_ver == "2.1":
        dataset_url = (
            "https://www.repository.cam.ac.uk/bitstream/handle/1810/294507/MULTIWOZ2.1.zip?sequence=1"
            "&isAllowed=y"
        )
    else:
        dataset_url = (
            "https://www.repository.cam.ac.uk/bitstream/handle/1810/280608/MULTIWOZ2.zip?sequence=3"
            "&isAllowed=y"
        )
